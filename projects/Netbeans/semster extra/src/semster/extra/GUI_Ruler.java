...
public class GUI_Ruler {
    ...
    public static JButton addBtn(int x, int y, int l, int h, String name, JFrame parentFrame, String tip) {
    ...
    public static JTextArea addtxt(int x, int y, int l, int h, String name, JFrame parentFrame, String tip) {
    ...
    public static JPasswordField addpass(int x, int y, int l, int h, String name, JFrame parentFrame, String tip) {
        JPasswordField pass = new JPasswordField();
        pass.setText(name);
        pass.setBounds(x, y, l, h);
        if (tip != null) {
            pass.setToolTipText(tip);
        }
    ...
    public static JFrame addFrm(boolean visib, boolean resize, int x, int y, int l, int h, String name, String imgName, String iconName, boolean exit, String tip , JPopupMenu JPM) {
        ...
        if (imgName != null) {
            ...
            try {
                ...
                if (tip != null) {
                    background.setToolTipText(tip);
                }
                if (JPM!= null) {
                    background.setComponentPopupMenu(JPM);
                }

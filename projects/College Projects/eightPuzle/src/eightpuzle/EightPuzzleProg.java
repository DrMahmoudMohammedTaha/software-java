...
public class EightPuzzleProg {
	...
	public static void main(String[] args) {
		epb = new EightPuzzleBoard(extreme);
	...
	private static void printActions(List<Action> actions) {
		for (int i = 0; i < actions.size(); i++) {
			...
			System.out.println(action);
                        epb = (EightPuzzleBoard)EightPuzzleFunctionFactory.getResultFunction().result(epb, actions.get(i));
...
// EightPuzzleBoard epb = new EightPuzzleBoard();

        //System.out.println(epb);
        //System.out.println("");
        //System.out.println(EightPuzzleFunctionFactory.getResultFunction().result(epb,(Action)(EightPuzzleFunctionFactory.getActionsFunction().actions(epb).toArray()[1])));
        //System.out.println( new EightPuzzleGoalTest().isGoalState(epb));

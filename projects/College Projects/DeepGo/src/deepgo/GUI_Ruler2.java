...
public class GUI_Ruler2 {
    ...
    public static String font1 = "Times New Roman";
    public static String font2 = "Times New Roman";
    ...
    public static JCheckBox addchk(int x, int y, int l, int h, String name, JFrame parentFrame) {
        ...
        chk.setFont(new Font(font1, Font.BOLD, 18));
        chk.repaint();
    ...
    public static JButton addBtn(int x, int y, int l, int h, String name, JFrame parentFrame) {
        ...
        btn.setFont(new Font(font1, Font.BOLD, 18));
        btn.repaint();
    ...
    public static JLabel addLbl(int x, int y, int l, int h, String name, JFrame parentFrame) {
        ...
        lbl.setFont(new Font(font1, Font.BOLD, 26));
        lbl.repaint();
    ...
    public static JTextArea addtxt(int x, int y, int l, int h, String name, JFrame parentFrame) {
        ...
        txt.setFont(new Font(font2, Font.BOLD, 21));
        txt.repaint();
    ...
    public static void makeCenter(JFrame frm , JComponent... cmnt  ) {
    for (int i = 0; i < cmnt.length; i++) {
            cmnt[i].setBounds((frm.getWidth() - cmnt[i].getWidth()) / 2, cmnt[i].getY(), cmnt[i].getWidth(), cmnt[i].getHeight());

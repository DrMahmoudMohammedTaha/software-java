...
var $adtext = (function ()
{
 ...
 var properties = {
  ...
  osname: '?',
  refer_url: 'http://www.wisc-online.com/objects/viewobject.aspx?id=dce2002',
  page_url: '?',
  refer_domain: 'wisc-online.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '41.69.123.197'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 41.69.123.197 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://www.wisc-online.com/objects/viewobject.aspx?id=dce2002'; */
    properties.page_domain=''; /* 'wisc-online.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('cnp42l32i2zpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function doMouseClickcnp42l32i2z()
 {
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg cnp42l32i2z_3, cnp42l32i2z_4, ... cnp42l32i2z_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'cnp42l32i2z';
     span.id = 'cnp42l32i2z' + "_" + properties.spancount;
     span.name='cnp42l32i2z' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'cnp42l32i2zspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickcnp42l32i2z,   false);
  addEvent(adpop_span, "click", doMouseClickcnp42l32i2z);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'cnp42l32i2zframe';
  gframe.name = 'cnp42l32i2zframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('cnp42l32i2zframe');
 ...
 function setupcnp42l32i2zCSS()
 {
  writeLog(1, 'setupcnp42l32i2zCSS()');
  ...
  // style.innerHTML = '.cnp42l32i2z { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.cnp42l32i2z { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.cnp42l32i2z {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.cnp42l32i2z {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.cnp42l32i2z {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';

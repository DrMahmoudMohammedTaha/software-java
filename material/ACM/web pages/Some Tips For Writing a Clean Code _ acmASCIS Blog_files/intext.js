...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  osname: '?',
  refer_url: 'http://www.search.ask.com/?o=apn10640a&gct=hp&d=473-103&v=a11465-169&t=4&tag=newtab',
  page_url: '?',
  refer_domain: 'search.ask.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '41.69.90.194'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 41.69.90.194 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://www.search.ask.com/?o=apn10640a&gct=hp&d=473-103&v=a11465-169&t=4&tag=newtab'; */
    properties.page_domain=''; /* 'search.ask.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('vbb31opop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg vbb31o_3, vbb31o_4, ... vbb31o_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'vbb31o';
     span.id = 'vbb31o' + "_" + properties.spancount;
     span.name='vbb31o' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'vbb31ospinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickvbb31o,   false);
  addEvent(adpop_span, "click", doMouseClickvbb31o);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'vbb31oframe';
  gframe.name = 'vbb31oframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('vbb31oframe');
 ...
 function setupvbb31oCSS()
 {
  writeLog(1, 'setupvbb31oCSS()');
  ...
  // style.innerHTML = '.vbb31o { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.vbb31o { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.vbb31o {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.vbb31o {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.vbb31o {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';

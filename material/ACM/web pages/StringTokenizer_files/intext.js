...
var $adtext = (function ()
{
 ...
 var properties = {
  ...
  osname: '?',
  refer_url: 'http://developer.android.com/reference/java/io/bufferedreader.html',
  page_url: '?',
  refer_domain: 'developer.android.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '41.235.214.3'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 41.235.214.3 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://developer.android.com/reference/java/io/bufferedreader.html'; */
    properties.page_domain=''; /* 'developer.android.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('t593q7ycpop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg t593q7yc_3, t593q7yc_4, ... t593q7yc_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 't593q7yc';
     span.id = 't593q7yc' + "_" + properties.spancount;
     span.name='t593q7yc' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 't593q7ycspinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickt593q7yc,   false);
  addEvent(adpop_span, "click", doMouseClickt593q7yc);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 't593q7ycframe';
  gframe.name = 't593q7ycframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('t593q7ycframe');
 ...
 function setupt593q7ycCSS()
 {
  writeLog(1, 'setupt593q7ycCSS()');
  ...
  // style.innerHTML = '.t593q7yc { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.t593q7yc { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.t593q7yc {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.t593q7yc {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.t593q7yc {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';

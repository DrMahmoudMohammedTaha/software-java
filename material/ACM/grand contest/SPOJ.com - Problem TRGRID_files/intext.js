...
var $adtext = (function ()
{
 ...
 var properties = {
  ...
  osname: '?',
  refer_url: 'http://ahmed-aly.com/contest.jsp?id=9472',
  page_url: '?',
  refer_domain: 'ahmed-aly.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '41.69.45.199'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 41.69.45.199 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://ahmed-aly.com/contest.jsp?id=9472'; */
    properties.page_domain=''; /* 'ahmed-aly.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('c5uyu6zopop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg c5uyu6zo_3, c5uyu6zo_4, ... c5uyu6zo_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'c5uyu6zo';
     span.id = 'c5uyu6zo' + "_" + properties.spancount;
     span.name='c5uyu6zo' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'c5uyu6zospinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickc5uyu6zo,   false);
  addEvent(adpop_span, "click", doMouseClickc5uyu6zo);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'c5uyu6zoframe';
  gframe.name = 'c5uyu6zoframe';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('c5uyu6zoframe');
 ...
 function setupc5uyu6zoCSS()
 {
  writeLog(1, 'setupc5uyu6zoCSS()');
  ...
  // style.innerHTML = '.c5uyu6zo { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.c5uyu6zo { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.c5uyu6zo {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.c5uyu6zo {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.c5uyu6zo {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';

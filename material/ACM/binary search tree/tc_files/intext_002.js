...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  osname: '?',
  refer_url: 'http://www.electronics-lab.com/projects/test/016/',
  page_url: '?',
  refer_domain: 'electronics-lab.com',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '41.235.209.142'; 
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 41.235.209.142 not supported. uip=' + properties.userip);
   return (0);
  }
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://www.electronics-lab.com/projects/test/016/'; */
    properties.page_domain=''; /* 'electronics-lab.com'; */
   }
...
function supportedCMS()
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('z8bp7u3pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg z8bp7u3_3, z8bp7u3_4, ... z8bp7u3_13 
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'z8bp7u3';
     span.id = 'z8bp7u3' + "_" + properties.spancount;
     span.name='z8bp7u3' + "_" + properties.spancount; 
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'z8bp7u3spinner';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClickz8bp7u3,   false);
  addEvent(adpop_span, "click", doMouseClickz8bp7u3);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'z8bp7u3frame';
  gframe.name = 'z8bp7u3frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('z8bp7u3frame');
 ...
 function setupz8bp7u3CSS()
 {
  writeLog(1, 'setupz8bp7u3CSS()');
  ...
  // style.innerHTML = '.z8bp7u3 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.z8bp7u3 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.z8bp7u3 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.z8bp7u3 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url('+properties.pageprotocol+'://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.z8bp7u3 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';

...
// Created: 3/6/2009 21:29:48

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid=SiteTrackingID;
	this.domain="206.204.120.7";
	this.timezone=-8;
	this.fpcdom="";
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,exe,bin,iso,sit,rar,gz,tar,tgz";
	this.rightclicktypes="xls,doc,pdf,txt,csv,zip,exe,bin,iso,sit,rar,gz,tar,tgz";

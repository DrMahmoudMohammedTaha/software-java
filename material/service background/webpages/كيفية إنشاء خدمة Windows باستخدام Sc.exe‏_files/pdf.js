                ...
                if (data && data.componentName === componentIdentifier)
                {
                    ...
                    $("#dgpsSearch").autocomplete({
                        ...
                        select: function (event, ui)
                        {
                            ...
                            self.triggerSearch(event, ui);
                            $(document).trigger('dgps.suggestionclick', ui);
                        },
                        minLength: 0,
                        delay: 100,
                    ...
                    self.triggerSearch = function (event, ui)
                    {
                        var searchRequest = {};
                        ...
                        if (searchPageUrl)
                        {
                            window.location.assign(searchPageUrl.format(encodeURIComponent(searchRequest.value), searchRequest.parentName));
                        }
                        else
                        {

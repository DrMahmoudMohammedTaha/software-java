    ...
    if (culture !== "" && isCtf === "true") {
        ...
        setTimeout(function () {
            ...
            s.src = ((location && location.href && location.href.indexOf('https') == 0) ? ctfSecureWidgetUrl : ctfWidgetUrl) +
                "?siteData=" + encodeURIComponent(siteData) + "&mode=manual&from=en&layout=ts&to=" + culture + "&originalDocument=/kb/KbView/" + contentId + "&category=e9b9dd63-c277-4572-9d08-fd459d9b844d_tech";

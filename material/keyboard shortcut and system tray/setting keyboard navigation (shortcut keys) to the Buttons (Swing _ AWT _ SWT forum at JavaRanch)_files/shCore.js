...
dp.sh.Toolbar.Commands = {
    ...
    // Jaikiran - As of October 5 2013, removed support for copy to clipboard. @see http://www.coderanch.com/t/619545/Ranch-Office/copy-clipboard-doesn-work
    // for one related discussion
//	CopyToClipboard: {
...
dp.sh.Toolbar.Create = function(highlighter)
{
    ...
    // Show a "note" to users telling them that content in code blocks is automatically word-wrapped
	div.innerHTML += '<div style="margin-top:5px;"><label>Note: Text content in the code blocks is automatically word-wrapped</label></div>';
	return div;
}
